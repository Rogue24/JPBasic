...
@property (nonatomic, weak) UIImageView *livePhotoIcon;
@end
...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        _noSelBorderColor = JPRGBAColor(88, 144, 255, 0.3);
        _seledBorderColor = JPRGBAColor(88, 144, 255, 1);
        ...
        UIImageView *livePhotoIcon = [UIImageView new];
        livePhotoIcon.image = [UIImage imageNamed:@"livephoto_icon"];
        [self addSubview:livePhotoIcon];
        [livePhotoIcon mas_makeConstraints:^(MASConstraintMaker *make) {
...
- (void)setPhotoVM:(JPPhotoViewModel *)photoVM {
    ...
    self.livePhotoIcon.hidden = !photoVM.isLivePhoto;
