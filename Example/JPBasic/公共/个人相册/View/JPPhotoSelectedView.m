...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.layer.shadowColor = JPRGBAColor(88, 144, 255, 0.1).CGColor;
        
        CALayer *line = [CALayer layer];
        line.frame = CGRectMake(0, 0, frame.size.width, JPSeparateLineThick + 0.01);
        line.backgroundColor = JPRGBAColor(88, 144, 255, 0.3).CGColor;
        ...
        JPScreenBorderButton *cancelBtn = ({
            ...
            [btn setBackgroundColor:JPRGBColor(202, 202, 202)];
        ...
        JPScreenBorderButton *confirmBtn = ({
            ...
            [btn setBackgroundColor:JPRGBColor(88, 144, 255)];
