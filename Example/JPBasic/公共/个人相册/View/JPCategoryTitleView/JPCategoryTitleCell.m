...
- (void)setTitleVM:(JPCategoryTitleViewModel *)titleVM {
    ...
    self.titleLabel.textColor = titleVM.isSelected ? JPRGBAColor(88, 144, 255, 1) : JPRGBAColor(88, 144, 255, 0.5);
...
- (void)updateSelectedState:(BOOL)isSelected animate:(BOOL)animate {
    ...
    UIColor *textColor = isSelected ? JPRGBAColor(88, 144, 255, 1) : JPRGBAColor(88, 144, 255, 0.5);
    if (animate) {
