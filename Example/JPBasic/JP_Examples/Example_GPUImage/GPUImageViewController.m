...
- (void)loadView
{
    CGRect mainScreenFrame = JPScreenBounds;
    GPUImageView *primaryView = [[GPUImageView alloc] initWithFrame:mainScreenFrame];
    primaryView.contentMode = UIViewContentModeScaleAspectFit;
    self.view = primaryView;
    
    imageSlider = [[UISlider alloc] initWithFrame:CGRectMake(25.0, mainScreenFrame.size.height - 100, mainScreenFrame.size.width - 50.0, 40.0)];
...
{
    UIImage *inputImage = [UIImage imageNamed:@"Joker.jpg"]; // The WID.jpg example is greater than 2048 pixels tall, so it fails on older devices
